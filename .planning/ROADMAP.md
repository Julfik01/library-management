...
- [x] 01-02-PLAN.md — Auth API: register, login, refresh, logout, RBAC, admin create-librarian (AUTH-01–04, 06, 07)

**Wave 3** *(blocked on Wave 2 completion)*

- [x] 01-03-PLAN.md — Frontend scaffold + auth context/axios + Login/Register/Dashboard slice (AUTH-01–03)

**Wave 4** *(blocked on Wave 3 completion)*

- [x] 01-04-PLAN.md — Create Librarian + Unauthorized screens + RBAC verification (AUTH-06, 07)
