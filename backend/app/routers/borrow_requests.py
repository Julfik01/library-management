...
from app.schemas.borrow_request import BorrowRequestCreate, BorrowRequestOut, BorrowRequestReject
...
async def reject(
    ...
    await reject_borrow_request(db, id, current_user.id, data.rejection_note)
